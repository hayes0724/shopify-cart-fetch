...
export declare type CartItemParams = CartItemAdd | CartItemRemove | CartItemUpdate | HTMLFormElement;
export declare type CartParams = Attributes | CartState["note"];
 ...
 *
 */
export declare type EventType = 'cart-add' | 'cart-remove' | 'cart-update' | 'cart-fetch';
export declare type EventStage = 'start' | 'complete' | 'error';
export declare type EventData = CartState | CartLineItem;
